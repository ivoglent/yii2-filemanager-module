...
<head>
    ...
    <link rel="stylesheet" href="<?= $assetUrl ?>/js/blueimp-file-upload/css/jquery.fileupload.css">
    <link rel="stylesheet" href="<?= $assetUrl ?>/js/blueimp-file-upload/css/jquery.fileupload-ui.css">
    <!-- CSS adjustments for browsers with JavaScript disabled -->
    <noscript>
        <link rel="stylesheet" href="<?= $assetUrl ?>/js/blueimp-file-upload/css/jquery.fileupload-noscript.css">
    </noscript>
    <noscript>
        <link rel="stylesheet" href="<?= $assetUrl ?>/js/blueimp-file-upload/css/jquery.fileupload-ui-noscript.css">
    </noscript>
    <link href="<?= $assetUrl ?>/js/jPlayer/skin/blue.monday/jplayer.blue.monday.css" rel="stylesheet" type="text/css">
    <link href="<?= $assetUrl ?>/css/style.css?v=<?php echo $version; ?>" rel="stylesheet" type="text/css"/>
    <!--[if lt IE 8]>
    <style>
    ...
    <script>
        window.fileManagerConfigs = <?=json_encode($fileManagerConfigs)?>;
    </script>
    <script src="<?= $assetUrl ?>/js/jquery.min.js"></script>
    <script src="<?= $assetUrl ?>/js/jquery-ui.min.js" type="text/javascript"></script>
    <script src="<?= $assetUrl ?>/js/plugins.js?v=<?php echo $version; ?>"></script>
    <script src="<?= $assetUrl ?>/js/jPlayer/jquery.jplayer/jquery.jplayer.js"></script>
    <script src="<?= $assetUrl ?>/js/modernizr.custom.js"></script>
    ...
    <script src="<?= $assetUrl ?>/js/include.js?v=<?php echo $version; ?>"></script>
</head>
<body>
<!-- The Templates plugin is included to render the upload/download listings -->
<script src="<?= $assetUrl ?>/js/tmpl.min.js"></script>
<!-- The Load Image plugin is included for the preview images and image resizing functionality -->
<script src="<?= $assetUrl ?>/js/load-image.all.min.js"></script>
<!-- The Canvas to Blob plugin is included for image resizing functionality -->
<script src="<?= $assetUrl ?>/js/canvas-to-blob.min.js"></script>
<!-- The Iframe Transport is required for browsers without support for XHR file uploads -->
<script src="<?= $assetUrl ?>/js/blueimp-file-upload/js/jquery.iframe-transport.js"></script>
<!-- The basic File Upload plugin -->
<script src="<?= $assetUrl ?>/js/blueimp-file-upload/js/jquery.fileupload.js"></script>
<!-- The File Upload processing plugin -->
<script src="<?= $assetUrl ?>/js/blueimp-file-upload/js/jquery.fileupload-process.js"></script>
<!-- The File Upload image preview & resize plugin -->
<script src="<?= $assetUrl ?>/js/blueimp-file-upload/js/jquery.fileupload-image.js"></script>
<!-- The File Upload audio preview plugin -->
<script src="<?= $assetUrl ?>/js/blueimp-file-upload/js/jquery.fileupload-audio.js"></script>
<!-- The File Upload video preview plugin -->
<script src="<?= $assetUrl ?>/js/blueimp-file-upload/js/jquery.fileupload-video.js"></script>
<!-- The File Upload validation plugin -->
<script src="<?= $assetUrl ?>/js/blueimp-file-upload/js/jquery.fileupload-validate.js"></script>
<!-- The File Upload user interface plugin -->
<script src="<?= $assetUrl ?>/js/blueimp-file-upload/js/jquery.fileupload-ui.js"></script>
...
<input type="hidden" id="current_url"
       value="<?php echo str_replace(array('&filter=' . $filter, '&sort_by=' . $sort_by, '&descending=' . intval($descending)), array(''), $_SERVER['REQUEST_URI']); ?>"/>
...
<div class="container-fluid">
    ...
    if ($ftp) {
        ...
        $fileDir = realpath($current_path . $rfm_subfolder . $subdir);
    ...
    <div class="row-fluid">
        <?php
        $link = $fileManagerConfigs['baseUrl'] . "/dialog?" . $get_params;
        ?>
        <ul class="breadcrumb">
            ...
            <li class="pull-right"><a id="refresh" class="btn-small"
                                      href="<?= $fileManagerConfigs['baseUrl'] ?>/dialog?<?php echo $get_params . $subdir . "&" . uniqid() ?>"><i
    ...
    <div class="row-fluid ff-container">
        <div class="span12">
            ...
            <ul class="grid cs-style-2 <?php echo "list-view" . $view; ?>" id="main-item-container">
                ...
                foreach ($files as $file_array) {
                    ...
                    <li data-name="<?php echo $file ?>"
                        ...
                        <figure data-name="<?php echo $file ?>"
                            ...
                            <?php } ?>
                            <a class="folder-link"
                               href="<?= $fileManagerConfigs['baseUrl'] ?>/dialog?<?php echo $get_params . rawurlencode($src) . "&" . ($callback ? 'callback=' . $callback . "&" : '') . uniqid() ?>">
                            ...
                            <div class="box">
                                <h4 class="<?php if ($ellipsis_title_after_first_row) {
                                    echo "ellipsis";
                                         ...
                                         href="dialog?<?php echo $get_params . rawurlencode($src) . "&" . uniqid() ?>"><?php echo $file; ?></a>
                                </h4>
                            </div>
                ...
                if (!$ftp) {
                    $file_path = $current_path . $rfm_subfolder . $subdir . $file;
                    $file_path = \yii\helpers\BaseUrl::base() .  str_replace(\Yii::getAlias('@webroot'), '', str_replace('\\', '/', $file_path));
                            ...
                            <form action="force_download.php" method="post" class="download-form"
                                ...
                                <?php } elseif (($is_video || $is_audio) && in_array($file_array['extension'], $jplayer_ext)) { ?>
                                    <a class="tip-right modalAV <?php if ($is_audio) {
                                       ...
                                       data-url="/ajax?action=media_preview&title=<?php echo $filename; ?>&file=<?php echo $rfm_subfolder . $subdir . $file; ?>"
                                ...
                                <?php } elseif (in_array($file_array['extension'], array('dwg', 'dxf', 'hpgl', 'plt', 'spl', 'step', 'stp', 'iges', 'igs', 'sat', 'cgm', 'svg'))) { ?>
                                    <a class="tip-right file-preview-btn" title="<?php echo trans('Preview') ?>"
                                       data-url="/ajax?action=cad_preview&title=<?php echo $filename; ?>&file=<?php echo $rfm_subfolder . $subdir . $file; ?>"
                                       href="javascript:void('');"><i class=" icon-eye-open"></i></a>
                                <?php } elseif ($preview_text_files && in_array($file_array['extension'], $previewable_text_file_exts)) { ?>
                                    <a class="tip-right file-preview-btn" title="<?php echo trans('Preview') ?>"
                                       data-url="/ajax?action=get_file&sub_action=preview&preview_mode=text&title=<?php echo $filename; ?>&file=<?php echo $rfm_subfolder . $subdir . $file; ?>"
                                       href="javascript:void('');"><i class=" icon-eye-open"></i></a>
                                <?php } elseif ($googledoc_enabled && in_array($file_array['extension'], $googledoc_file_exts)) { ?>
                                    <a class="tip-right file-preview-btn" title="<?php echo trans('Preview') ?>"
                                       data-url="/ajax?action=get_file&sub_action=preview&preview_mode=google&title=<?php echo $filename; ?>&file=<?php echo $rfm_subfolder . $subdir . $file; ?>"
...
<div id="loading_container" style="display:none;">
    ...
    <img id="loading_animation" src="<?= $assetUrl ?>/img/storing_animation.gif" alt="loading"

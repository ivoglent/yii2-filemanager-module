...
| <input type="button" href="../filemanager/dialog?field_id=imgField&lang=en_EN&akey=myPrivateKey" value="Files">
...
$baseUploadPath = \Yii::$app->controller->module->baseUploadDirectory;
if (\Yii::$app->controller->module->userDir) {
    $userDirAttr = \Yii::$app->controller->module->userDir;
    $baseUploadPath = $baseUploadPath . DIRECTORY_SEPARATOR . $user->$userDirAttr;
}
...
$orgPath = $baseUploadPath . DIRECTORY_SEPARATOR . 'org';
$thumbPath = $baseUploadPath . DIRECTORY_SEPARATOR . 'thumbs';
if (!is_dir($orgPath)) {
...
$uploadPathUrl = str_replace(\Yii::getAlias('@webroot'), '', str_replace('\\', '/', $orgPath)) . '/';


$relativeOrgPath = \yii\helpers\BaseUrl::base(). str_replace(\Yii::getAlias('@webroot'), '', str_replace('\\', '/', $orgPath)) . '/';
$relativeThumbPath = \yii\helpers\BaseUrl::base() . str_replace(\Yii::getAlias('@webroot'), '', str_replace('\\', '/', $thumbPath)) . '/';
...
$config = array(
	...
	*/
	...
	|--------------------------------------------------------------------------
	*/
	'default_language' => \Yii::$app->language,

...
/*if (isset($_SESSION['RF']['language']) && file_exists( dirname(__FILE__) .'/lang/' . basename($_SESSION['RF']['language']) . '.php'))
{
	$languages = include dirname(__FILE__) .'/lang/languages.php';
	if(array_key_exists($_SESSION['RF']['language'],$languages)){
		include dirname(__FILE__) . '/lang/' . basename($_SESSION['RF']['language']) . '.php';
	}else{
